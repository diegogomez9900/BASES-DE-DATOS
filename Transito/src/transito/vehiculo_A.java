 ...
 * @author Diego Gomez
 */
public class vehiculo_A extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel6.setText("Codigo Del Registro Vehiculo a Actualizar");
        ...
        jLabel1.setText("Ingrese el Nuevo Codigo de Casa");

        nombre.setText("Cod_Casa");
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        if("".equals(nombre.getText())){
            ...
            casaa=nombre.getText();
            sql = "UPDATE Vehiculo SET Codigo_Casa = ? WHERE Codigo_Vehiculo = ?";
            try {
            PreparedStatement pst = cn.prepareStatement(sql);
            pst.setString(1,casaa);
            ...
            Logger.getLogger(vehiculo_A.class.getName()).log(Level.SEVERE, null, ex);
        }
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(vehiculo_A.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new vehiculo_A().setVisible(true);
            }
        });
    }
