 ...
 * @author Diego Gomez
 */
public class agente_A extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel6.setText("Codigo Del Registro Agente a Actualizar");
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addComponent(nombre, javax.swing.GroupLayout.DEFAULT_SIZE, 63, Short.MAX_VALUE)
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        if("".equals(nombre.getText())){
            ...
            sql = "UPDATE Agente SET Nombre_Agente = ? WHERE Codigo_Agente = ?";
            try {
            ...
            Logger.getLogger(agente_A.class.getName()).log(Level.SEVERE, null, ex);
        }
        }
        ...
        if("".equals(apellido.getText())){
            ...
            sql = "UPDATE Agente SET Apellido_Agente = ? WHERE Codigo_Agente = ?";
            try {
            PreparedStatement pst = cn.prepareStatement(sql);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(agente_A.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
