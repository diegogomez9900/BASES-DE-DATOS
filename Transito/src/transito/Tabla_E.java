...
public class Tabla_E extends javax.swing.JFrame {
    
    public Tabla_E() {
        initComponents();
        this.setLocationRelativeTo(null);
    }
    public Tabla_E(String sql){
        initComponents();
        this.setLocationRelativeTo(null);
        mostrar(sql);
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Tabla_E.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
